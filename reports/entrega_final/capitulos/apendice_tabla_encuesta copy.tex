...
\begin{longtable}{
  ...
  \label{tab:encuestas}\\
    \cline{1-16}
      Marca temporal 
    & Edad 
    & Rango salarial\tnote{1}
    & Oficina\tnote{2}
    & Cantidad \tnote{3}
    & Interés\tnote{4}
    & Horas en solitario\tnote{5}
    & Muebles\tnote{6}
    & Permiso\tnote{7}
    & Opciones \tnote{8}
    & Preocupación\tnote{9}
    & Pautas de tranquilidad\tnote{10}
    & Expectativas\tnote{11}
    & Costo mensual\tnote{12}
    & Gasto mensual\tnote{13}
    & Características aplicación\tnote{14}
    & \parbox[t]{2mm}{\multirow{7}{*}{\rotatebox[origin=c]{270}{{\sffamily\fontsize{18pt}{27pt}\selectfont\color{aqua}Anexo A. Resultados de la encuesta}\vspace*{7pt}}}} \\
    \cline{1-16}
  \endfirsthead
  ...
  \endhead
    \cline{1-16}
    \multicolumn{16}{l}{\footnotesize\itshape Continua en la siguiente página.} & \\ 
  \endfoot
    \cline{1-16}
